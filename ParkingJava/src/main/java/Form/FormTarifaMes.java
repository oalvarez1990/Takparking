 ...
 * @author FrankS
 */
public class FormTarifaMes extends javax.swing.JFrame {

    /**
     * Creates new form FormTarifaHora
     */
    public FormTarifaMes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tarifa mensual");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTarifaMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTarifaMes().setVisible(true);
            }
        });
    }
